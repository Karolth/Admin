...
<body>
    ...
    <div class="modal-content" style="background: rgb(255, 255, 255); padding: 20px; border-radius: 8px; width: 400px; margin: 5% auto; position: relative;">
        <span onclick="cerrarModalEditar()" style="position: absolute; top: 10px; right: 15px; cursor: pointer; font-size: 20px;">&times;</span>
        <h2>Editar Producto</h2>
        <form id="formEditarProducto" onsubmit="guardarEdicionProducto(); return false;">
            <input type="hidden" id="edit_id_producto">

            <label for="edit_nombre_producto">Nombre del Producto:</label>
            <input type="text" id="edit_nombre_producto" required style="width: 100%; padding: 8px; margin-top: 5px; margin-bottom: 10px;">

            <label for="edit_imagen_producto">Imagen:</label>
            <input type="file" id="edit_imagen_producto" style="width: 100%; margin-top: 5px; margin-bottom: 10px;">

            <label for="edit_descripcion_producto">Descripción:</label>
            <textarea id="edit_descripcion_producto" required style="width: 100%; padding: 8px; margin-top: 5px; margin-bottom: 10px;"></textarea>

            <label for="edit_precio_producto">Precio:</label>
            <input type="number" id="edit_precio_producto" required step="0.01" style="width: 100%; padding: 8px; margin-top: 5px; margin-bottom: 10px;">

            <label for="edit_categoria_producto">Categoría:</label>
            <select id="edit_categoria_producto" required style="width: 100%; padding: 8px; margin-top: 5px; margin-bottom: 10px;">
                </select>

            <label for="edit_proveedor_producto">Proveedor:</label>
            <select  id="edit_proveedor_producto" required style="width: 100%; padding: 8px; margin-top: 5px; margin-bottom: 10px;">
                </select>
